...
/** \file
 * Implementation of a stationary, pressure-driven axisymmetric Hagen-Poiseuille flow, and
 * comparison with the analytical Hagen-Poiseuille profile. The velocity is initialized
                   ...
                   InletOutletT inletOutlet )
{
    ...
    // Neumann boundary condition on bottom wall is set for a "reasonable" macroscopic variable along the center line. 
...
int main(int argc, char* argv[]) {
    ...
    applyProcessingFunctional(new GetAbsoluteRFunctional<T,DESCRIPTOR>, lattice.getBoundingBox(), lattice);
