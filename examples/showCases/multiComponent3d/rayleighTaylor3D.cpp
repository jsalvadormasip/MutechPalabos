...
public:
    ...
    virtual void execute([[maybe_unused]] plint iX, plint iY, [[maybe_unused]] plint iZ, T rand_val, Cell<T,Descriptor>& cell) const {
...
#else
    const plint statIter = 1;
    const plint maxIter = 11;
#endif
