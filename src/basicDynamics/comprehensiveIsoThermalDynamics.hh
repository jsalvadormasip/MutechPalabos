...
void RMdynamics<T, Descriptor>::collideExternal(
    Cell<T, Descriptor> &cell, [[maybe_unused]] T rhoBar, Array<T, Descriptor<T>::d> const &j, [[maybe_unused]] T thetaBar,
...
void RMdynamics<T, Descriptor>::computeEquilibria(
    Array<T, Descriptor<T>::q> &fEq, T rhoBar, Array<T, Descriptor<T>::d> const &j, [[maybe_unused]] T jSqr,
...
void CMdynamics<T, Descriptor>::collideExternal(
    Cell<T, Descriptor> &cell, T rhoBar, [[maybe_unused]] Array<T, Descriptor<T>::d> const &j, [[maybe_unused]] T thetaBar,
    BlockStatistics &stat)
{
    T falseRho;
    Array<T, Descriptor<T>::d> u;
