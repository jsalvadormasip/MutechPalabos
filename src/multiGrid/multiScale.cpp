...
void ConvectiveMultiScaleManager::scaleVelocity([[maybe_unused]] Array<double,2>& u, [[maybe_unused]] plint nLevel) const
{
    // Velocity is scale-invariant in convective scaling.
}

void ConvectiveMultiScaleManager::scaleVelocity([[maybe_unused]] Array<double,3>& u, [[maybe_unused]] plint nLevel) const
{
    // Velocity is scale-invariant in convective scaling.
}
