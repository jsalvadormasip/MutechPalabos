...
public:
    ...
    virtual void velocityToParticle([[maybe_unused]] TensorField3D<T, 3> &velocityField, [[maybe_unused]] T scaling = 1.) { }
    virtual void velocityToParticle([[maybe_unused]] NTensorField3D<T> &velocityField, [[maybe_unused]] T scaling = 1.) { }
    virtual void rhoBarJtoParticle([[maybe_unused]] NTensorField3D<T> &rhoBarJfield, [[maybe_unused]] bool velIsJ, [[maybe_unused]] T scaling = 1.) { }
    virtual void fluidToParticle([[maybe_unused]] BlockLattice3D<T, Descriptor> &fluid, [[maybe_unused]] T scaling = 1.) { }
    virtual void fluidToParticle(
        [[maybe_unused]] BlockLattice3D<T, Descriptor> &fluid, [[maybe_unused]] ScalarField3D<T> &sF, T scaling = 1.)
    { }
