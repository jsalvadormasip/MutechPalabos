...
public:
    ...
    virtual void velocityToParticle([[maybe_unused]] TensorField2D<T, 2> &velocityField, [[maybe_unused]] T scaling = 1.) { }
    virtual void velocityToParticle([[maybe_unused]] NTensorField2D<T> &velocityField, [[maybe_unused]] T scaling = 1.) { }
    virtual void rhoBarJtoParticle([[maybe_unused]] NTensorField2D<T> &rhoBarJfield, [[maybe_unused]] bool velIsJ, [[maybe_unused]] T scaling = 1.) { }
    virtual void fluidToParticle([[maybe_unused]] BlockLattice2D<T, Descriptor> &fluid, [[maybe_unused]] T scaling = 1.) { }
