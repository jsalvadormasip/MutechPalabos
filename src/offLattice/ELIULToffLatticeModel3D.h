...
#ifndef ELIULT_OFF_LATTICE_MODEL_3D_H
#define ELIULT_OFF_LATTICE_MODEL_3D_H
...
class ELIULTLocalModel3D : public OffLatticeModel3D<T, Array < T,3> >
{
public:
    ELIULTLocalModel3D(BoundaryShape3D<T,Array<T,3> >* shape_,
                       int flowType_);
    virtual ELIULTLocalModel3D<T,Descriptor>* clone() const;
...
#endif  // ELIULT_OFF_LATTICE_MODEL_3D_H
