...
class ELIULModel3D : public OffLatticeModel3D<T, Array<T, 3> > {
public:
   ELIULModel3D(BoundaryShape3D<T, Array<T, 3> > *shape_, int flowType_);
   virtual ELIULModel3D<T, Descriptor> *clone() const;
