...
template<typename T>
void transformVertexProperty(ConnectedTriangleMesh<T>& mesh, plint whichProperty, T scale, T offset = 0.0);

template<typename T>
void transformVertexProperty(ConnectedTriangleMesh<T>& mesh, std::string propertyName, T scale, T offset = 0.0);
