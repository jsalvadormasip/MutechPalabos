...
InamuroIteration2D<T,VelFunction>::InamuroIteration2D(VelFunction velFunction_, T tau_, bool incompressibleModel_)
...
template<typename T, class VelFunction>
IndexedInamuroIteration2D<T,VelFunction>::IndexedInamuroIteration2D(VelFunction velFunction_, T tau_, bool incompressibleModel_)
    : velFunction(velFunction_),
      tau(tau_),
      incompressibleModel(incompressibleModel_)
{ }
