...
template <typename T>
int pointOnTriangle (
        Array<T,3> const& point1, Array<T,3> const& point2, int flag, typename TriangleMesh<T>::Triangle const& triangle,
...
bool segmentIntersectsTriangle (
        Array<T,3> const& point1, Array<T,3> const& point2, typename TriangleMesh<T>::Triangle const& triangle );
