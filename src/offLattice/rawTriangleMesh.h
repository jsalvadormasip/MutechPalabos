...
template<typename T> class RawTriangleMesh;
template<typename T> class STLreader;
...
public:
    ...
    RawTriangleMesh( std::vector<std::vector<RawTriangle> > const& triangles_,
    ...
    RawTriangleMesh<T> refineRecursively(T targetMaxEdgeLength, plint maxNumIterations, bool& success) const;
    RawTriangleMesh<T> refineByArea(T triangleAreaThreshold) const;
    RawTriangleMesh<T> refineByAreaRecursively(T targetMaxTriangleArea, plint maxNumIterations, bool& success) const;
