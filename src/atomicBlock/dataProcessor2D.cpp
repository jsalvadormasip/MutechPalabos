...
void DataProcessorGenerator2D::rescale([[maybe_unused]] double dxScale_, [[maybe_unused]] double dtScale_)
{ }

/** \param dxScale Scale factor for space scale dx.
 *  \param dtScale Scale factor for time scale dt.
 */
void DataProcessorGenerator2D::setscale([[maybe_unused]] int dxScale_, [[maybe_unused]] int dtScale_)
{ }
...
void DataProcessorGenerator2D::serialize([[maybe_unused]] Box2D& domain, [[maybe_unused]] std::string& data) const
{ }
...
void BoxedDataProcessorGenerator2D::serialize(Box2D& domain_, [[maybe_unused]] std::string& data) const
{
    domain_ = domain;
}
...
void ReductiveDataProcessorGenerator2D::rescale([[maybe_unused]] double dxScale, [[maybe_unused]] double dtScale)
{ }
...
void ReductiveDataProcessorGenerator2D::serialize([[maybe_unused]] Box2D& domain, [[maybe_unused]] std::string& data) const
{ }
...
void BoxedReductiveDataProcessorGenerator2D::serialize(Box2D& domain_, [[maybe_unused]] std::string& data) const
{
    domain_ = domain;
}
