...
public:
    ...
    virtual void send([[maybe_unused]] Box2D domain, [[maybe_unused]] std::vector<char>& buffer, [[maybe_unused]] modif::ModifT kind) const { }
    virtual void receive([[maybe_unused]] Box2D domain, [[maybe_unused]] std::vector<char> const& buffer, [[maybe_unused]] modif::ModifT kind ) { }
    ...
    virtual void attribute([[maybe_unused]] Box2D toDomain, [[maybe_unused]] plint deltaX, [[maybe_unused]] plint deltaY,
                           [[maybe_unused]] AtomicBlock2D const& from, [[maybe_unused]] modif::ModifT kind) { }
