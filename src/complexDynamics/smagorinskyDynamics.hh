...
template<typename T, template<typename U> class Descriptor>
T ConsistentSgsBGKdynamics<T,Descriptor>::getDynamicParameter(plint whichParameter, [[maybe_unused]] Cell<T,Descriptor> const& cell) const
{
//     if (whichParameter==dynamicParams::dynamicOmega) {
//         T rhoBar;
//         Array<T,Descriptor<T>::d> j;
...
template<typename T, template<typename U> class Descriptor>
T ConsistentSgsMRTdynamics<T,Descriptor>::getDynamicParameter(plint whichParameter, [[maybe_unused]] Cell<T,Descriptor> const& cell) const
{
//     if (whichParameter==dynamicParams::dynamicOmega) {
//         T rhoBar;
//         Array<T,Descriptor<T>::d> j;
...
template<typename T, template<typename U> class Descriptor>
T ConsistentSmagorinskyIncMRTdynamics<T,Descriptor>::getDynamicParameter(plint whichParameter, [[maybe_unused]] Cell<T,Descriptor> const& cell) const
{
    if (whichParameter==dynamicParams::smagorinskyConstant) {
        return cSmago;
    } else if (whichParameter==dynamicParams::dynamicOmega) {
