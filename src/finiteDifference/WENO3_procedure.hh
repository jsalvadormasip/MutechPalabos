        ...
        for (plint iY = domain.y0; iY <= domain.y1; ++iY) {
            for (plint iZ = domain.z0; iZ <= domain.z1; ++iZ) {
                ...
                if (neumann) {
                    if (absoluteX == 0) {
                        (util::greaterThan(u[0], (T)0)
                             ? (phiW1 = phiC)
                             : (util::lessThan(u[0], (T)0) ? (phiC = phiE1) : (phiW1 = phiE1)));
                        adv[0] =
                            (util::greaterThan(u[0], (T)0)
                                 ? (phiC - phiW1)
                                 : (util::lessThan(u[0], (T)0) ? (phiE1 - phiC)
                                                               : (T)0.5 * (phiE1 - phiW1)));
                        adv[1] =
                            (util::greaterThan(u[1], (T)0)
                                 ? (phiC - phiS1)
                                 : (util::lessThan(u[1], (T)0) ? (phiN1 - phiC)
                                                               : (T)0.5 * (phiN1 - phiS1)));
                        adv[2] =
                            (util::greaterThan((u[2] + v_sedC), (T)0)
                                 ? (phiC - phiB1)
                                 : (util::lessThan((u[2] + v_sedC), (T)0)
                                        ? (phiT1 - phiC)
                                        : (T)0.5 * (phiT1 - phiB1)));
                    ...
                    if (absoluteX == nx - 1) {
                        (util::greaterThan(u[0], (T)0)
                             ? (phiC = phiW1)
                             : (util::lessThan(u[0], (T)0) ? (phiE1 = phiC) : (phiE1 = phiW1)));
                        adv[0] =
                            (util::greaterThan(u[0], (T)0)
                                 ? (phiC - phiW1)
                                 : (util::lessThan(u[0], (T)0) ? (phiE1 - phiC)
                    ...
                    if (absoluteY == 0) {
                        (util::greaterThan(u[1], (T)0)
                             ? (phiS1 = phiC)
                             : (util::lessThan(u[1], (T)0) ? (phiC = phiN1) : (phiS1 = phiN1)));
                        adv[0] =
                            (util::greaterThan(u[0], (T)0)
                                 ? (phiC - phiW1)
                                 : (util::lessThan(u[0], (T)0) ? (phiE1 - phiC)
                    ...
                    if (absoluteY == ny - 1) {
                        (util::greaterThan(u[1], (T)0)
                             ? (phiC = phiS1)
                             : (util::lessThan(u[1], (T)0) ? (phiN1 = phiC) : (phiN1 = phiS1)));
                        adv[0] =
                            (util::greaterThan(u[0], (T)0)
                                 ? (phiC - phiW1)
                                 : (util::lessThan(u[0], (T)0) ? (phiE1 - phiC)
                    ...
                    if (absoluteZ == 0) {
                        (util::greaterThan((u[2] + v_sedC), (T)0)
                             ? (phiB1 = phiC)
                             : (util::lessThan((u[2] + v_sedC), (T)0) ? (phiC = phiT1)
                                                                      : (phiB1 = phiT1)));
                        adv[0] =
                            (util::greaterThan(u[0], (T)0)
                                 ? (phiC - phiW1)
                    ...
                    if (absoluteZ == nz - 1) {
                        (util::greaterThan((u[2] + v_sedC), (T)0)
                             ? (phiC = phiB1)
                             : (util::lessThan((u[2] + v_sedC), (T)0) ? (phiT1 = phiC)
                                                                      : (phiT1 = phiB1)));
                        adv[0] =
                            (util::greaterThan(u[0], (T)0)
                                 ? (phiC - phiW1)
                ...
                result->get(iX + ofs2.x, iY + ofs2.y, iZ + ofs2.z) =
                    -advection + Q->get(iX + ofs4.x, iY + ofs4.y, iZ + ofs4.z) - accu + diff;
            }
        }
    }
}
...
/******************************3rd order Runge-Kutta for the time
 * discretization***************************************************/
/* ******** RK3_Step1_functional3D ****************************************** */

template <typename T>
void RK3_Step1_functional3D<T>::process(Box3D domain, std::vector<ScalarField3D<T> *> fields)
{
...
template <typename T>
void RK3_Step2_functional3D<T>::process(Box3D domain, std::vector<ScalarField3D<T> *> fields)
{
...
template <typename T>
void RK3_Step3_functional3D<T>::process(Box3D domain, std::vector<ScalarField3D<T> *> fields)
{
    PLB_PRECONDITION(fields.size() == 4);
    ScalarField3D<T> &phi_n = *fields[0];
