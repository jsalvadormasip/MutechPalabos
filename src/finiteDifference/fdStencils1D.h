...
template <typename T, int nDim>
inline T cornerXderiv(
    TensorField3D<T, nDim> const &velocity, int normalX, [[maybe_unused]] int normalY, [[maybe_unused]] int normalZ, plint iX,
    plint iY, plint iZ, int iD)
{
    int orientation = normalX;
    return -orientation
...
template <typename T, int nDim>
inline T cornerYderiv(
    TensorField3D<T, nDim> const &velocity, [[maybe_unused]] int normalX, int normalY, [[maybe_unused]] int normalZ, plint iX,
    plint iY, plint iZ, int iD)
{
    int orientation = normalY;
    return -orientation
...
template <typename T, int nDim>
inline T cornerZderiv(
    TensorField3D<T, nDim> const &velocity, [[maybe_unused]] int normalX, [[maybe_unused]] int normalY, int normalZ, plint iX,
    plint iY, plint iZ, int iD)
{
    int orientation = normalZ;
    return -orientation
...
template <typename T>
inline T cornerXderiv(ScalarField2D<T> const &field, int normalX, [[maybe_unused]] int normalY, plint iX, plint iY)
{
    int orientation = normalX;
...
template <typename T>
inline T cornerYderiv(ScalarField2D<T> const &field, [[maybe_unused]] int normalX, int normalY, plint iX, plint iY)
{
    int orientation = normalY;
...
template <typename T, int nDim>
inline T cornerXderiv(
    TensorField2D<T, nDim> const &velocity, int normalX, [[maybe_unused]] int normalY, plint iX, plint iY, int iD)
{
    int orientation = normalX;
    return -orientation
...
template <typename T, int nDim>
inline T cornerYderiv(
    TensorField2D<T, nDim> const &velocity, [[maybe_unused]] int normalX, int normalY, plint iX, plint iY, int iD)
{
    int orientation = normalY;
    return -orientation
