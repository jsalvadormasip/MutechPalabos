...
struct comprehensiveDynamicsTemplatesImpl<T, descriptors::D2Q9DescriptorBase<T> > {
    ...
    // General way to compute CMs (computations of velocity components are based on Palabos ordering
    // of discrete velocities !)
    ...
    // ordering of discrete velocities !)
    ...
    // General way to compute Ks (computations of velocity components are based on Palabos ordering
    // of discrete velocities !)
        ...
        Array<T, D::numRelaxationTimes> const &omega)
    {
        ...
        cell[F00] = (rho * 4. / 9.)
                    * (1. - (3. / 2.) * (RRcoll[M20] + RRcoll[M02]) + (9. / 4.) * (RRcoll[M22]));

        cell[FP0] = (rho / 9.)
                    * (1. + 3. * u[0] + (3. / 2.) * (2. * RRcoll[M20] - RRcoll[M02])
                       - (9. / 2.) * (RRcoll[M12]) - (9. / 4.) * (2. * RRcoll[M22]));
        cell[FM0] = (rho / 9.)
                    * (1. - 3. * u[0] + (3. / 2.) * (2. * RRcoll[M20] - RRcoll[M02])
                       + (9. / 2.) * (RRcoll[M12]) - (9. / 4.) * (2. * RRcoll[M22]));
        cell[F0P] = (rho / 9.)
                    * (1. + 3. * u[1] + (3. / 2.) * (2. * RRcoll[M02] - RRcoll[M20])
                       - (9. / 2.) * (RRcoll[M21]) - (9. / 4.) * (2. * RRcoll[M22]));
        cell[F0M] = (rho / 9.)
                    * (1. - 3. * u[1] + (3. / 2.) * (2. * RRcoll[M02] - RRcoll[M20])
                       + (9. / 2.) * (RRcoll[M21]) - (9. / 4.) * (2. * RRcoll[M22]));

        cell[FPP] = (rho / 36.)
                    * (1. + 3. * (+u[0] + u[1]) + (3. / 2.) * (2. * RRcoll[M20] + 2. * RRcoll[M02])
                       + 9. * RRcoll[M11] + (9. / 2.) * (2. * RRcoll[M21] + 2. * RRcoll[M12])
                       + (9. / 2.) * (2. * RRcoll[M22]));
        cell[FMP] = (rho / 36.)
                    * (1. + 3. * (-u[0] + u[1]) + (3. / 2.) * (2. * RRcoll[M20] + 2. * RRcoll[M02])
                       - 9. * RRcoll[M11] + (9. / 2.) * (2. * RRcoll[M21] - 2. * RRcoll[M12])
