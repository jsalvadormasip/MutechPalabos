...
struct comprehensiveDynamicsTemplates {
    ...
    static void RMcomputeEquilibriumMoments(
        T rho, Array<T, Descriptor<T>::d> const &u, Array<T, Descriptor<T>::q> &RMeq)
    {
        comprehensiveDynamicsTemplatesImpl<
            T, typename Descriptor<T>::BaseDescriptor>::RMcomputeEquilibriumMoments(rho, u, RMeq);
    }
    ...
    static void HMcomputeEquilibriumMoments(
        T rho, Array<T, Descriptor<T>::d> const &u, Array<T, Descriptor<T>::q> &HMeq)
    {
        comprehensiveDynamicsTemplatesImpl<
            T, typename Descriptor<T>::BaseDescriptor>::HMcomputeEquilibriumMoments(rho, u, HMeq);
    }
    ...
    {
        comprehensiveDynamicsTemplatesImpl<
            T, typename Descriptor<T>::BaseDescriptor>::KcomputeEquilibriumMoments(Keq);
    }
    ...
    static void GHcomputeEquilibriumMoments(
        T rho, Array<T, Descriptor<T>::d> const &u, Array<T, Descriptor<T>::q> &GHeq)
    {
        comprehensiveDynamicsTemplatesImpl<
            T, typename Descriptor<T>::BaseDescriptor>::GHcomputeEquilibriumMoments(rho, u, GHeq);
    }
    ...
    {
        comprehensiveDynamicsTemplatesImpl<
            T, typename Descriptor<T>::BaseDescriptor>::RRcomputeEquilibriumMoments(rho, u, GHeq);
    }
...
struct comprehensiveDynamicsTemplatesImpl {
    ...
    static void RMcomputeEquilibriumMoments(
        T rho, Array<T, Descriptor::d> const &u, Array<T, Descriptor::q> &RMeq)
    {
        // We only provide specialized implementations.
        PLB_ASSERT(false);
    }
    ...
    static void HMcomputeEquilibriumMoments(
        T rho, Array<T, Descriptor::d> const &u, Array<T, Descriptor::q> &HMeq)
    {
        // We only provide specialized implementations.
        PLB_ASSERT(false);
    }
    ...
    static void GHcomputeEquilibriumMoments(
        T rho, Array<T, Descriptor::d> const &u, Array<T, Descriptor::q> &GHeq)
    {
        // We only provide specialized implementations.
        PLB_ASSERT(false);
    }
