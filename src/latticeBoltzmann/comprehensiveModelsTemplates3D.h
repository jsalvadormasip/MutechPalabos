...
// Optimized way to compute RMs (general ordering of discrete velocities)
static void RMcomputeMoments(Array<T,D::q> const& cell, Array<T, D::q>& RM, T& rho) {
    Array<T, D::q> f;
    for (int i = 0; i<27; ++i) {
        f[i] = cell[i] + D::t[i];
    ...
    T X_0  = f[F0M0] + f[F00M] + f[F0MM] + f[F0MP] + f[F000] + f[F0P0] + f[F00P] + f[F0PP] + f[F0PM];

    T Y_M1 = f[F0M0] + f[FMM0] + f[F0MM] + f[F0MP] + f[FMMM] + f[FMMP] + f[FPM0] + f[FPMP] + f[FPMM];
    T Y_P1 = f[F0P0] + f[FPP0] + f[F0PP] + f[F0PM] + f[FPPP] + f[FPPM] + f[FMP0] + f[FMPM] + f[FMPP];

    T Z_M1 = f[F00M] + f[FM0M] + f[F0MM] + f[FMMM] + f[FMPM] + f[FP0M] + f[F0PM] + f[FPPM] + f[FPMM];
    T Z_P1 = f[F00P] + f[FP0P] + f[F0PP] + f[FPPP] + f[FPMP] + f[FM0P] + f[F0MP] + f[FMMP] + f[FMPP];
                      ...
                      Array<T, D::numRelaxationTimes> const& omega)
{
    ...
    cell[FPP0] = 0.25*rho * ( RMcoll[M110] + RMcoll[M210] + RMcoll[M120] - RMcoll[M112] + RMcoll[M220] - RMcoll[M212] - RMcoll[M122] - RMcoll[M222]);
    cell[FMP0] =  0.5*rho * (-RMcoll[M110]                - RMcoll[M120] + RMcoll[M112]                               + RMcoll[M122])+ cell[FPP0];
    cell[FPM0] =  0.5*rho * (-RMcoll[M110] - RMcoll[M210]                + RMcoll[M112]                + RMcoll[M212]               )+ cell[FPP0];
    cell[FMM0] =  0.5*rho * (              - RMcoll[M210] - RMcoll[M120]                               + RMcoll[M212] + RMcoll[M122])+ cell[FPP0];

    cell[FP0P] = 0.25*rho * ( RMcoll[M101] + RMcoll[M201] + RMcoll[M102] - RMcoll[M121] + RMcoll[M202] - RMcoll[M221] - RMcoll[M122] - RMcoll[M222]);
    cell[FM0P] =  0.5*rho * (-RMcoll[M101]                - RMcoll[M102] + RMcoll[M121]                               + RMcoll[M122])+ cell[FP0P];
    cell[FP0M] =  0.5*rho * (-RMcoll[M101] - RMcoll[M201]                + RMcoll[M121]                + RMcoll[M221]               )+ cell[FP0P];
    cell[FM0M] =  0.5*rho * (              - RMcoll[M201] - RMcoll[M102]                               + RMcoll[M221] + RMcoll[M122])+ cell[FP0P];

    cell[F0PP] = 0.25*rho * ( RMcoll[M011] + RMcoll[M021] + RMcoll[M012] - RMcoll[M211] + RMcoll[M022] - RMcoll[M221] - RMcoll[M212] - RMcoll[M222]);
    cell[F0MP] =  0.5*rho * (-RMcoll[M011]                - RMcoll[M012] + RMcoll[M211]                               + RMcoll[M212])+ cell[F0PP];
    cell[F0PM] =  0.5*rho * (-RMcoll[M011] - RMcoll[M021]                + RMcoll[M211]                + RMcoll[M221]               )+ cell[F0PP];
    cell[F0MM] =  0.5*rho * (              - RMcoll[M021] - RMcoll[M012]                               + RMcoll[M221] + RMcoll[M212])+ cell[F0PP];

    cell[FPPP] = 0.125*rho * ( RMcoll[M111] + RMcoll[M211] + RMcoll[M121] + RMcoll[M112] + RMcoll[M221] + RMcoll[M212] + RMcoll[M122] + RMcoll[M222]);
    cell[FMPP] =  0.25*rho * (-RMcoll[M111]                - RMcoll[M121] - RMcoll[M112]                               - RMcoll[M122])+ cell[FPPP];
    cell[FPMP] =  0.25*rho * (-RMcoll[M111] - RMcoll[M211]                - RMcoll[M112]                - RMcoll[M212]               )+ cell[FPPP];
    cell[FPPM] =  0.25*rho * (-RMcoll[M111] - RMcoll[M211] - RMcoll[M121]                - RMcoll[M221]                              )+ cell[FPPP];
    cell[FMMP] =  0.25*rho * (              - RMcoll[M211] - RMcoll[M121]                               - RMcoll[M212] - RMcoll[M122])+ cell[FPPP];
    cell[FMPM] =  0.25*rho * (              - RMcoll[M211]                - RMcoll[M112] - RMcoll[M221]                - RMcoll[M122])+ cell[FPPP];
    cell[FPMM] =  0.25*rho * (                             - RMcoll[M121] - RMcoll[M112] - RMcoll[M221] - RMcoll[M212]               )+ cell[FPPP];
...
// Optimized way to compute HMs (general ordering of discrete velocities)
static void HMcomputeMoments(Array<T,D::q> const& cell, Array<T, D::q>& HM, T& rho) {
    Array<T, D::q> f;
    for (int i = 0; i<27; ++i) {
        f[i] = cell[i] + D::t[i];
    ...
    HM[M222] -= (D::cs2*(HM[M220] + HM[M202] + HM[M022]) + cs4*(HM[M200] + HM[M020] + HM[M002]) + D::cs2*cs4);
};
...
// Equilibrium populations based on 27 moments can be computed using either RM, HM, CM, CHM or Gauss-Hermite formalisms. 
// All formulations are equivalent for the D3Q27 so we use the fastest one (RMs)
...
/*    HMcoll[M200] = (1.-omega1) * HM[M200] + omega1 * HMeq[M200] ;
    ...
    RMcoll[M222] = HMcoll[M222] + D::cs2*(HMcoll[M220] + HMcoll[M202] + HMcoll[M022]) + cs4*(HMcoll[M200] + HMcoll[M020] + HMcoll[M002]) + D::cs2*cs4;
...
// Optimized way to compute CMs (general ordering of discrete velocities)
static void CMcomputeMoments(Array<T,D::q> const& cell, Array<T, D::q>& CM, T& rho, Array<T,D::d>& u) {
    ...
    CM[M211] -= (u[2]*CM[M210] + u[1]*CM[M201] + 2.*u[0]*CM[M111] + u[1]*u[2]*CM[M200] + 2.*u[0]*u[2]*CM[M110] + 2.*u[0]*u[1]*CM[M101] + ux2*CM[M011] + ux2*u[1]*u[2]);
    CM[M121] -= (u[2]*CM[M120] + u[0]*CM[M021] + 2.*u[1]*CM[M111] + u[0]*u[2]*CM[M020] + 2.*u[1]*u[2]*CM[M110] + 2.*u[0]*u[1]*CM[M011] + uy2*CM[M101] + u[0]*uy2*u[2]);
    CM[M112] -= (u[1]*CM[M102] + u[0]*CM[M012] + 2.*u[2]*CM[M111] + u[0]*u[1]*CM[M002] + 2.*u[1]*u[2]*CM[M101] + 2.*u[0]*u[2]*CM[M011] + uz2*CM[M110] + u[0]*u[1]*uz2);

    CM[M221] -= (u[2]*CM[M220] + 2.*u[1]*CM[M211] + 2.*u[0]*CM[M121] + 2.*u[1]*u[2]*CM[M210] + uy2*CM[M201] + ux2*CM[M021] + 2.*u[0]*u[2]*CM[M120] + 4.*u[0]*u[1]*CM[M111] + uy2*u[2]*CM[M200] + ux2*u[2]*CM[M020] + 4.*uxyz*CM[M110] + 2.*u[0]*uy2*CM[M101] + 2.*ux2*u[1]*CM[M011] + ux2*uy2*u[2]);
    CM[M212] -= (u[1]*CM[M202] + 2.*u[2]*CM[M211] + 2.*u[0]*CM[M112] + 2.*u[1]*u[2]*CM[M201] + uz2*CM[M210] + ux2*CM[M012] + 2.*u[0]*u[1]*CM[M102] + 4.*u[0]*u[2]*CM[M111] + u[1]*uz2*CM[M200] + ux2*u[1]*CM[M002] + 4.*uxyz*CM[M101] + 2.*u[0]*uz2*CM[M110] + 2.*ux2*u[2]*CM[M011] + ux2*u[1]*uz2);
...
// Optimized way to compute CHMs (general ordering of discrete velocities)
static void CHMcomputeMoments(Array<T,D::q> const& cell, Array<T, D::q>& CHM, T& rho, Array<T,D::d>& u) {
    Array<T, D::q> f;
    for (int i = 0; i<27; ++i) {
        f[i] = cell[i] + D::t[i];
    ...
    CHM[M220] -= (2.*u[1]*CHM[M210] + 2.*u[0]*CHM[M120] + uy2*CHM[M200] + ux2*CHM[M020] + 4.*u[0]*u[1]*CHM[M110] + ux2*uy2);
    CHM[M202] -= (2.*u[2]*CHM[M201] + 2.*u[0]*CHM[M102] + uz2*CHM[M200] + ux2*CHM[M002] + 4.*u[0]*u[2]*CHM[M101] + ux2*uz2);
    CHM[M022] -= (2.*u[2]*CHM[M021] + 2.*u[1]*CHM[M012] + uz2*CHM[M020] + uy2*CHM[M002] + 4.*u[1]*u[2]*CHM[M011] + uy2*uz2);

    CHM[M211] -= (u[2]*CHM[M210] + u[1]*CHM[M201] + 2.*u[0]*CHM[M111] + u[1]*u[2]*CHM[M200] + 2.*u[0]*u[2]*CHM[M110] + 2.*u[0]*u[1]*CHM[M101] + ux2*CHM[M011] + ux2*u[1]*u[2]);
    CHM[M121] -= (u[2]*CHM[M120] + u[0]*CHM[M021] + 2.*u[1]*CHM[M111] + u[0]*u[2]*CHM[M020] + 2.*u[1]*u[2]*CHM[M110] + 2.*u[0]*u[1]*CHM[M011] + uy2*CHM[M101] + u[0]*uy2*u[2]);
    CHM[M112] -= (u[1]*CHM[M102] + u[0]*CHM[M012] + 2.*u[2]*CHM[M111] + u[0]*u[1]*CHM[M002] + 2.*u[1]*u[2]*CHM[M101] + 2.*u[0]*u[2]*CHM[M011] + uz2*CHM[M110] + u[0]*u[1]*uz2);

    CHM[M221] -= (u[2]*CHM[M220] + 2.*u[1]*CHM[M211] + 2.*u[0]*CHM[M121] + 2.*u[1]*u[2]*CHM[M210] + uy2*CHM[M201] + ux2*CHM[M021] + 2.*u[0]*u[2]*CHM[M120] + 4.*u[0]*u[1]*CHM[M111] + uy2*u[2]*CHM[M200] + ux2*u[2]*CHM[M020] + 4.*uxyz*CHM[M110] + 2.*u[0]*uy2*CHM[M101] + 2.*ux2*u[1]*CHM[M011] + ux2*uy2*u[2]);
    CHM[M212] -= (u[1]*CHM[M202] + 2.*u[2]*CHM[M211] + 2.*u[0]*CHM[M112] + 2.*u[1]*u[2]*CHM[M201] + uz2*CHM[M210] + ux2*CHM[M012] + 2.*u[0]*u[1]*CHM[M102] + 4.*u[0]*u[2]*CHM[M111] + u[1]*uz2*CHM[M200] + ux2*u[1]*CHM[M002] + 4.*uxyz*CHM[M101] + 2.*u[0]*uz2*CHM[M110] + 2.*ux2*u[2]*CHM[M011] + ux2*u[1]*uz2);
    CHM[M122] -= (u[0]*CHM[M022] + 2.*u[2]*CHM[M121] + 2.*u[1]*CHM[M112] + 2.*u[0]*u[2]*CHM[M021] + uz2*CHM[M120] + uy2*CHM[M102] + 2.*u[0]*u[1]*CHM[M012] + 4.*u[1]*u[2]*CHM[M111] + u[0]*uz2*CHM[M020] + u[0]*uy2*CHM[M002] + 4.*uxyz*CHM[M011] + 2.*u[1]*uz2*CHM[M110] + 2.*uy2*u[2]*CHM[M101] + u[0]*uy2*uz2);
...
// Optimized way to compute Ks (general ordering of discrete velocities)
static void KcomputeMoments(Array<T,D::q> const& cell, Array<T, D::q>& K, T& rho, Array<T,D::d>& u) {
    ...
    K[M220] -= (2.*u[1]*K[M210] + 2.*u[0]*K[M120] + uy2*K[M200] + ux2*K[M020] + 4.*u[0]*u[1]*K[M110] + ux2*uy2);
    K[M202] -= (2.*u[2]*K[M201] + 2.*u[0]*K[M102] + uz2*K[M200] + ux2*K[M002] + 4.*u[0]*u[2]*K[M101] + ux2*uz2);
    K[M022] -= (2.*u[2]*K[M021] + 2.*u[1]*K[M012] + uz2*K[M020] + uy2*K[M002] + 4.*u[1]*u[2]*K[M011] + uy2*uz2);

    K[M211] -= (u[2]*K[M210] + u[1]*K[M201] + 2.*u[0]*K[M111] + u[1]*u[2]*K[M200] + 2.*u[0]*u[2]*K[M110] + 2.*u[0]*u[1]*K[M101] + ux2*K[M011] + ux2*u[1]*u[2]);
    K[M121] -= (u[2]*K[M120] + u[0]*K[M021] + 2.*u[1]*K[M111] + u[0]*u[2]*K[M020] + 2.*u[1]*u[2]*K[M110] + 2.*u[0]*u[1]*K[M011] + uy2*K[M101] + u[0]*uy2*u[2]);
    K[M112] -= (u[1]*K[M102] + u[0]*K[M012] + 2.*u[2]*K[M111] + u[0]*u[1]*K[M002] + 2.*u[1]*u[2]*K[M101] + 2.*u[0]*u[2]*K[M011] + uz2*K[M110] + u[0]*u[1]*uz2);

    K[M221] -= (u[2]*K[M220] + 2.*u[1]*K[M211] + 2.*u[0]*K[M121] + 2.*u[1]*u[2]*K[M210] + uy2*K[M201] + ux2*K[M021] + 2.*u[0]*u[2]*K[M120] + 4.*u[0]*u[1]*K[M111] + uy2*u[2]*K[M200] + ux2*u[2]*K[M020] + 4.*uxyz*K[M110] + 2.*u[0]*uy2*K[M101] + 2.*ux2*u[1]*K[M011] + ux2*uy2*u[2]);
    K[M212] -= (u[1]*K[M202] + 2.*u[2]*K[M211] + 2.*u[0]*K[M112] + 2.*u[1]*u[2]*K[M201] + uz2*K[M210] + ux2*K[M012] + 2.*u[0]*u[1]*K[M102] + 4.*u[0]*u[2]*K[M111] + u[1]*uz2*K[M200] + ux2*u[1]*K[M002] + 4.*uxyz*K[M101] + 2.*u[0]*uz2*K[M110] + 2.*ux2*u[2]*K[M011] + ux2*u[1]*uz2);
    K[M122] -= (u[0]*K[M022] + 2.*u[2]*K[M121] + 2.*u[1]*K[M112] + 2.*u[0]*u[2]*K[M021] + uz2*K[M120] + uy2*K[M102] + 2.*u[0]*u[1]*K[M012] + 4.*u[1]*u[2]*K[M111] + u[0]*uz2*K[M020] + u[0]*uy2*K[M002] + 4.*uxyz*K[M011] + 2.*u[1]*uz2*K[M110] + 2.*uy2*u[2]*K[M101] + u[0]*uy2*uz2);

    K[M222] -= (2.*u[2]*K[M221] + 2.*u[1]*K[M212] + 2.*u[0]*K[M122] + uz2*K[M220] + uy2*K[M202] + ux2*K[M022] + 4.*u[1]*u[2]*K[M211] + 4.*u[0]*u[2]*K[M121] + 4.*u[0]*u[1]*K[M112] + 2.*u[1]*uz2*K[M210] + 2.*uy2*u[2]*K[M201] + 2.*ux2*u[2]*K[M021] + 2.*u[0]*uz2*K[M120] + 2.*u[0]*uy2*K[M102] + 2.*ux2*u[1]*K[M012] + 8.*uxyz*K[M111] + uy2*uz2*K[M200] + ux2*uz2*K[M020] + ux2*uy2*K[M002] + 4.*u[0]*u[1]*uz2*K[M110] + 4.*u[0]*uy2*u[2]*K[M101] + 4.*ux2*u[1]*u[2]*K[M011] + ux2*uy2*uz2);
...
*/
// Optimized way to compute GHs (general ordering of discrete velocities)
static void GHcomputeMoments(Array<T,D::q> const& cell, Array<T, D::q>& GH, T& rho) {
    Array<T, D::q> f;
    for (int i = 0; i<27; ++i) {
        f[i] = cell[i] + D::t[i];
    ...
    GH[M222] -= (D::cs2*(GH[M220] + GH[M202] + GH[M022]) + cs4*(GH[M200] + GH[M020] + GH[M002]) + D::cs2*cs4);
};
                      ...
                      Array<T, D::numRelaxationTimes> const& omega)
{
    ...
    cell[F000] = (rho*8./27.) * (1. - 3./2.*GHcoll[M200] - 3./2.*GHcoll[M020] - 3./2.*GHcoll[M002] + 9./4.*GHcoll[M220] + 9./4.*GHcoll[M202] + 9./4.*GHcoll[M022] - 27./8.*GHcoll[M222]);

    cell[FP00] = (rho*2./27.) * (1. + 3.*u[0] + 3.*GHcoll[M200] - 3./2.*GHcoll[M020] - 3./2.*GHcoll[M002] - 9./2.*GHcoll[M120] - 9./2.*GHcoll[M102] - 9./2.*GHcoll[M220] - 9./2.*GHcoll[M202] + 9./4.*GHcoll[M022] + 27./4.*GHcoll[M122] + 27./4.*GHcoll[M222]);
    cell[FM00] = (rho*2./27.) * (1. - 3.*u[0] + 3.*GHcoll[M200] - 3./2.*GHcoll[M020] - 3./2.*GHcoll[M002] + 9./2.*GHcoll[M120] + 9./2.*GHcoll[M102] - 9./2.*GHcoll[M220] - 9./2.*GHcoll[M202] + 9./4.*GHcoll[M022] - 27./4.*GHcoll[M122] + 27./4.*GHcoll[M222]);
    cell[F0P0] = (rho*2./27.) * (1. + 3.*u[1] - 3./2.*GHcoll[M200] + 3.*GHcoll[M020] - 3./2.*GHcoll[M002] - 9./2.*GHcoll[M210] - 9./2.*GHcoll[M012] - 9./2.*GHcoll[M220] + 9./4.*GHcoll[M202] - 9./2.*GHcoll[M022] + 27./4.*GHcoll[M212] + 27./4.*GHcoll[M222]);
    cell[F0M0] = (rho*2./27.) * (1. - 3.*u[1] - 3./2.*GHcoll[M200] + 3.*GHcoll[M020] - 3./2.*GHcoll[M002] + 9./2.*GHcoll[M210] + 9./2.*GHcoll[M012] - 9./2.*GHcoll[M220] + 9./4.*GHcoll[M202] - 9./2.*GHcoll[M022] - 27./4.*GHcoll[M212] + 27./4.*GHcoll[M222]);
    cell[F00P] = (rho*2./27.) * (1. + 3.*u[2] - 3./2.*GHcoll[M200] - 3./2.*GHcoll[M020] + 3.*GHcoll[M002] - 9./2.*GHcoll[M201] - 9./2.*GHcoll[M021] + 9./4.*GHcoll[M220] - 9./2.*GHcoll[M202] - 9./2.*GHcoll[M022] + 27./4.*GHcoll[M221] + 27./4.*GHcoll[M222]);
    cell[F00M] = (rho*2./27.) * (1. - 3.*u[2] - 3./2.*GHcoll[M200] - 3./2.*GHcoll[M020] + 3.*GHcoll[M002] + 9./2.*GHcoll[M201] + 9./2.*GHcoll[M021] + 9./4.*GHcoll[M220] - 9./2.*GHcoll[M202] - 9./2.*GHcoll[M022] - 27./4.*GHcoll[M221] + 27./4.*GHcoll[M222]);

    cell[FPP0] = (rho / 54.)  * (1. + 3.*u[0] + 3.*u[1] + 3.*GHcoll[M200] + 3.*GHcoll[M020] - 3./2.*GHcoll[M002] + 9.*GHcoll[M110] + 9.*GHcoll[M210] + 9.*GHcoll[M120] - 9./2.*GHcoll[M102] - 9./2.*GHcoll[M012] + 9.*GHcoll[M220] - 9./2.*GHcoll[M202] - 9./2.*GHcoll[M022] - 27./2.*GHcoll[M112] - 27./2.*GHcoll[M212] - 27./2.*GHcoll[M122] - 27./2.*GHcoll[M222]);
    cell[FMP0] = (rho / 54.)  * (1. - 3.*u[0] + 3.*u[1] + 3.*GHcoll[M200] + 3.*GHcoll[M020] - 3./2.*GHcoll[M002] - 9.*GHcoll[M110] + 9.*GHcoll[M210] - 9.*GHcoll[M120] + 9./2.*GHcoll[M102] - 9./2.*GHcoll[M012] + 9.*GHcoll[M220] - 9./2.*GHcoll[M202] - 9./2.*GHcoll[M022] + 27./2.*GHcoll[M112] - 27./2.*GHcoll[M212] + 27./2.*GHcoll[M122] - 27./2.*GHcoll[M222]);
    cell[FPM0] = (rho / 54.)  * (1. + 3.*u[0] - 3.*u[1] + 3.*GHcoll[M200] + 3.*GHcoll[M020] - 3./2.*GHcoll[M002] - 9.*GHcoll[M110] - 9.*GHcoll[M210] + 9.*GHcoll[M120] - 9./2.*GHcoll[M102] + 9./2.*GHcoll[M012] + 9.*GHcoll[M220] - 9./2.*GHcoll[M202] - 9./2.*GHcoll[M022] + 27./2.*GHcoll[M112] + 27./2.*GHcoll[M212] - 27./2.*GHcoll[M122] - 27./2.*GHcoll[M222]);
    cell[FMM0] = (rho / 54.)  * (1. - 3.*u[0] - 3.*u[1] + 3.*GHcoll[M200] + 3.*GHcoll[M020] - 3./2.*GHcoll[M002] + 9.*GHcoll[M110] - 9.*GHcoll[M210] - 9.*GHcoll[M120] + 9./2.*GHcoll[M102] + 9./2.*GHcoll[M012] + 9.*GHcoll[M220] - 9./2.*GHcoll[M202] - 9./2.*GHcoll[M022] - 27./2.*GHcoll[M112] + 27./2.*GHcoll[M212] + 27./2.*GHcoll[M122] - 27./2.*GHcoll[M222]);
    cell[FP0P] = (rho / 54.)  * (1. + 3.*u[0] + 3.*u[2] + 3.*GHcoll[M200] - 3./2.*GHcoll[M020] + 3.*GHcoll[M002] + 9.*GHcoll[M101] + 9.*GHcoll[M201] - 9./2.*GHcoll[M021] - 9./2.*GHcoll[M120] + 9.*GHcoll[M102] - 9./2.*GHcoll[M220] + 9.*GHcoll[M202] - 9./2.*GHcoll[M022] - 27./2.*GHcoll[M121] - 27./2.*GHcoll[M221] - 27./2.*GHcoll[M122] - 27./2.*GHcoll[M222]);
    cell[FM0P] = (rho / 54.)  * (1. - 3.*u[0] + 3.*u[2] + 3.*GHcoll[M200] - 3./2.*GHcoll[M020] + 3.*GHcoll[M002] - 9.*GHcoll[M101] + 9.*GHcoll[M201] - 9./2.*GHcoll[M021] + 9./2.*GHcoll[M120] - 9.*GHcoll[M102] - 9./2.*GHcoll[M220] + 9.*GHcoll[M202] - 9./2.*GHcoll[M022] + 27./2.*GHcoll[M121] - 27./2.*GHcoll[M221] + 27./2.*GHcoll[M122] - 27./2.*GHcoll[M222]);
    cell[FP0M] = (rho / 54.)  * (1. + 3.*u[0] - 3.*u[2] + 3.*GHcoll[M200] - 3./2.*GHcoll[M020] + 3.*GHcoll[M002] - 9.*GHcoll[M101] - 9.*GHcoll[M201] + 9./2.*GHcoll[M021] - 9./2.*GHcoll[M120] + 9.*GHcoll[M102] - 9./2.*GHcoll[M220] + 9.*GHcoll[M202] - 9./2.*GHcoll[M022] + 27./2.*GHcoll[M121] + 27./2.*GHcoll[M221] - 27./2.*GHcoll[M122] - 27./2.*GHcoll[M222]);
    cell[FM0M] = (rho / 54.)  * (1. - 3.*u[0] - 3.*u[2] + 3.*GHcoll[M200] - 3./2.*GHcoll[M020] + 3.*GHcoll[M002] + 9.*GHcoll[M101] - 9.*GHcoll[M201] + 9./2.*GHcoll[M021] + 9./2.*GHcoll[M120] - 9.*GHcoll[M102] - 9./2.*GHcoll[M220] + 9.*GHcoll[M202] - 9./2.*GHcoll[M022] - 27./2.*GHcoll[M121] + 27./2.*GHcoll[M221] + 27./2.*GHcoll[M122] - 27./2.*GHcoll[M222]);
    cell[F0PP] = (rho / 54.)  * (1. + 3.*u[1] + 3.*u[2] - 3./2.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] + 9.*GHcoll[M011] - 9./2.*GHcoll[M210] - 9./2.*GHcoll[M201] + 9.*GHcoll[M021] + 9.*GHcoll[M012] - 9./2.*GHcoll[M220] - 9./2.*GHcoll[M202] + 9.*GHcoll[M022] - 27./2.*GHcoll[M211] - 27./2.*GHcoll[M221] - 27./2.*GHcoll[M212] - 27./2.*GHcoll[M222]);
    cell[F0MP] = (rho / 54.)  * (1. - 3.*u[1] + 3.*u[2] - 3./2.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] - 9.*GHcoll[M011] + 9./2.*GHcoll[M210] - 9./2.*GHcoll[M201] + 9.*GHcoll[M021] - 9.*GHcoll[M012] - 9./2.*GHcoll[M220] - 9./2.*GHcoll[M202] + 9.*GHcoll[M022] + 27./2.*GHcoll[M211] - 27./2.*GHcoll[M221] + 27./2.*GHcoll[M212] - 27./2.*GHcoll[M222]);
    cell[F0PM] = (rho / 54.)  * (1. + 3.*u[1] - 3.*u[2] - 3./2.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] - 9.*GHcoll[M011] - 9./2.*GHcoll[M210] + 9./2.*GHcoll[M201] - 9.*GHcoll[M021] + 9.*GHcoll[M012] - 9./2.*GHcoll[M220] - 9./2.*GHcoll[M202] + 9.*GHcoll[M022] + 27./2.*GHcoll[M211] + 27./2.*GHcoll[M221] - 27./2.*GHcoll[M212] - 27./2.*GHcoll[M222]);
    cell[F0MM] = (rho / 54.)  * (1. - 3.*u[1] - 3.*u[2] - 3./2.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] + 9.*GHcoll[M011] + 9./2.*GHcoll[M210] + 9./2.*GHcoll[M201] - 9.*GHcoll[M021] - 9.*GHcoll[M012] - 9./2.*GHcoll[M220] - 9./2.*GHcoll[M202] + 9.*GHcoll[M022] - 27./2.*GHcoll[M211] + 27./2.*GHcoll[M221] + 27./2.*GHcoll[M212] - 27./2.*GHcoll[M222]);

    cell[FPPP] = (rho / 216.) * (1. + 3.*u[0] + 3.*u[1] + 3.*u[2] + 3.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] + 9.*GHcoll[M110] + 9.*GHcoll[M101] + 9.*GHcoll[M011] + 9.*GHcoll[M210] + 9.*GHcoll[M201] + 9.*GHcoll[M021] + 9.*GHcoll[M120] + 9.*GHcoll[M102] + 9.*GHcoll[M012] + 27.*GHcoll[M111] + 9.*GHcoll[M220] + 9.*GHcoll[M202] + 9.*GHcoll[M022] + 27.*GHcoll[M211] + 27.*GHcoll[M121] + 27.*GHcoll[M112] + 27.*GHcoll[M221] + 27.*GHcoll[M212] + 27.*GHcoll[M122] + 27.*GHcoll[M222]);
    cell[FMPP] = (rho / 216.) * (1. - 3.*u[0] + 3.*u[1] + 3.*u[2] + 3.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] - 9.*GHcoll[M110] - 9.*GHcoll[M101] + 9.*GHcoll[M011] + 9.*GHcoll[M210] + 9.*GHcoll[M201] + 9.*GHcoll[M021] - 9.*GHcoll[M120] - 9.*GHcoll[M102] + 9.*GHcoll[M012] - 27.*GHcoll[M111] + 9.*GHcoll[M220] + 9.*GHcoll[M202] + 9.*GHcoll[M022] + 27.*GHcoll[M211] - 27.*GHcoll[M121] - 27.*GHcoll[M112] + 27.*GHcoll[M221] + 27.*GHcoll[M212] - 27.*GHcoll[M122] + 27.*GHcoll[M222]);
    cell[FPMP] = (rho / 216.) * (1. + 3.*u[0] - 3.*u[1] + 3.*u[2] + 3.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] - 9.*GHcoll[M110] + 9.*GHcoll[M101] - 9.*GHcoll[M011] - 9.*GHcoll[M210] + 9.*GHcoll[M201] + 9.*GHcoll[M021] + 9.*GHcoll[M120] + 9.*GHcoll[M102] - 9.*GHcoll[M012] - 27.*GHcoll[M111] + 9.*GHcoll[M220] + 9.*GHcoll[M202] + 9.*GHcoll[M022] - 27.*GHcoll[M211] + 27.*GHcoll[M121] - 27.*GHcoll[M112] + 27.*GHcoll[M221] - 27.*GHcoll[M212] + 27.*GHcoll[M122] + 27.*GHcoll[M222]);
    cell[FPPM] = (rho / 216.) * (1. + 3.*u[0] + 3.*u[1] - 3.*u[2] + 3.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] + 9.*GHcoll[M110] - 9.*GHcoll[M101] - 9.*GHcoll[M011] + 9.*GHcoll[M210] - 9.*GHcoll[M201] - 9.*GHcoll[M021] + 9.*GHcoll[M120] + 9.*GHcoll[M102] + 9.*GHcoll[M012] - 27.*GHcoll[M111] + 9.*GHcoll[M220] + 9.*GHcoll[M202] + 9.*GHcoll[M022] - 27.*GHcoll[M211] - 27.*GHcoll[M121] + 27.*GHcoll[M112] - 27.*GHcoll[M221] + 27.*GHcoll[M212] + 27.*GHcoll[M122] + 27.*GHcoll[M222]);
    cell[FMMP] = (rho / 216.) * (1. - 3.*u[0] - 3.*u[1] + 3.*u[2] + 3.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] + 9.*GHcoll[M110] - 9.*GHcoll[M101] - 9.*GHcoll[M011] - 9.*GHcoll[M210] + 9.*GHcoll[M201] + 9.*GHcoll[M021] - 9.*GHcoll[M120] - 9.*GHcoll[M102] - 9.*GHcoll[M012] + 27.*GHcoll[M111] + 9.*GHcoll[M220] + 9.*GHcoll[M202] + 9.*GHcoll[M022] - 27.*GHcoll[M211] - 27.*GHcoll[M121] + 27.*GHcoll[M112] + 27.*GHcoll[M221] - 27.*GHcoll[M212] - 27.*GHcoll[M122] + 27.*GHcoll[M222]);
    cell[FMPM] = (rho / 216.) * (1. - 3.*u[0] + 3.*u[1] - 3.*u[2] + 3.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] - 9.*GHcoll[M110] + 9.*GHcoll[M101] - 9.*GHcoll[M011] + 9.*GHcoll[M210] - 9.*GHcoll[M201] - 9.*GHcoll[M021] - 9.*GHcoll[M120] - 9.*GHcoll[M102] + 9.*GHcoll[M012] + 27.*GHcoll[M111] + 9.*GHcoll[M220] + 9.*GHcoll[M202] + 9.*GHcoll[M022] - 27.*GHcoll[M211] + 27.*GHcoll[M121] - 27.*GHcoll[M112] - 27.*GHcoll[M221] + 27.*GHcoll[M212] - 27.*GHcoll[M122] + 27.*GHcoll[M222]);
    cell[FPMM] = (rho / 216.) * (1. + 3.*u[0] - 3.*u[1] - 3.*u[2] + 3.*GHcoll[M200] + 3.*GHcoll[M020] + 3.*GHcoll[M002] - 9.*GHcoll[M110] - 9.*GHcoll[M101] + 9.*GHcoll[M011] - 9.*GHcoll[M210] - 9.*GHcoll[M201] - 9.*GHcoll[M021] + 9.*GHcoll[M120] + 9.*GHcoll[M102] - 9.*GHcoll[M012] + 27.*GHcoll[M111] + 9.*GHcoll[M220] + 9.*GHcoll[M202] + 9.*GHcoll[M022] + 27.*GHcoll[M211] - 27.*GHcoll[M121] - 27.*GHcoll[M112] - 27.*GHcoll[M221] - 27.*GHcoll[M212] + 27.*GHcoll[M122] + 27.*GHcoll[M222]);
...
static void RRcomputeMoments(Array<T,D::q> const& cell, Array<T, D::q>& RR, T& rho) {
    ...
    T X_P1 = f[FP00] + f[FPP0] + f[FPM0] + f[FP0P] + f[FP0M] + f[FPPP] + f[FPPM] + f[FPMP] + f[FPMM];
    T X_0  = f[F0M0] + f[F00M] + f[F0MM] + f[F0MP] + f[F000] + f[F0P0] + f[F00P] + f[F0PP] + f[F0PM];
    ...
    RR[M110] = invRho * (f[FMM0] - f[FMP0] + f[FMMM] + f[FMMP] - f[FMPM] - f[FMPP] + f[FPP0] - f[FPM0] + f[FPPP] + f[FPPM] - f[FPMP] - f[FPMM]);
    RR[M101] = invRho * (f[FM0M] - f[FM0P] + f[FMMM] - f[FMMP] + f[FMPM] - f[FMPP] + f[FP0P] - f[FP0M] + f[FPPP] - f[FPPM] + f[FPMP] - f[FPMM]);
    RR[M011] = invRho * (f[F0MM] - f[F0MP] + f[FMMM] - f[FMMP] - f[FMPM] + f[FMPP] + f[F0PP] - f[F0PM] + f[FPPP] - f[FPPM] - f[FPMP] + f[FPMM]);
                      ...
                      Array<T, D::numRelaxationTimes> const& omega)
{
    ...
    RMcoll[M222] = RRcoll[M222] + D::cs2*(RRcoll[M220] + RRcoll[M202] + RRcoll[M022]) + cs4*(RRcoll[M200] + RRcoll[M020] + RRcoll[M002]) + D::cs2*cs4;
...
static void RMcomputeMoments(Array<T,D::q> const& cell, Array<T, D::q>& RM, T& rho) {
    ...
    T X_0  = f[F000] + f[F0M0] + f[F00M] + f[F0MM] + f[F0MP] + f[F0P0] + f[F00P] + f[F0PP] + f[F0PM];
...
static void RMcomputeEquilibrium(T rho, Array<T, D::q> const& RMeq, Array<T, D::q>& eq) {
    ...
    eq[F000] = rho *(1. - RMeq[M200] - RMeq[M020] - RMeq[M002] + RMeq[M220] + RMeq[M202] + RMeq[M022]);
    
    eq[FP00] = 0.5*rho * ( u[0] + RMeq[M200] - RMeq[M120] - RMeq[M102] - RMeq[M220] - RMeq[M202]);
    eq[FM00] =     rho * (-u[0]              + RMeq[M120] + RMeq[M102])+ eq[FP00];

    eq[F0P0] = 0.5*rho * ( u[1] + RMeq[M020] - RMeq[M210] - RMeq[M012] - RMeq[M220] - RMeq[M022]);
    eq[F0M0] =     rho * (-u[1]              + RMeq[M210] + RMeq[M012])+ eq[F0P0];

    eq[F00P] = 0.5*rho * ( u[2] + RMeq[M002] - RMeq[M201] - RMeq[M021] - RMeq[M202] - RMeq[M022]);
...
/*    RMcoll[M200] = (1.-omega1) * RM[M200] + omega1 * RMeq[M200] ;
    ...
    // Compute post collision populations from RM
    // Optimization based on symmetries between populations and their opposite counterpart
    cell[F000] = rho *(1. - RMcoll[M200] - RMcoll[M020] - RMcoll[M002] + RMcoll[M220] + RMcoll[M202] + RMcoll[M022]);
    
    cell[FP00] = 0.5*rho * ( u[0] + RMcoll[M200] - RMcoll[M120] - RMcoll[M102] - RMcoll[M220] - RMcoll[M202]);
    cell[FM00] =     rho * (-u[0]                + RMcoll[M120] + RMcoll[M102])+ cell[FP00];

    cell[F0P0] = 0.5*rho * ( u[1] + RMcoll[M020] - RMcoll[M210] - RMcoll[M012] - RMcoll[M220] - RMcoll[M022]);
    cell[F0M0] =     rho * (-u[1]                + RMcoll[M210] + RMcoll[M012])+ cell[F0P0];

    cell[F00P] = 0.5*rho * ( u[2] + RMcoll[M002] - RMcoll[M201] - RMcoll[M021] - RMcoll[M202] - RMcoll[M022]);
...
*/
    ...
    cell[F000] = (rho * D::t[F000]) * (1. -1.5*(GHcoll[M200] + GHcoll[M020] + GHcoll[M002])+ (9./7.)*GHcoll[M220] + (9./5.)*GHcoll[M202] + 3.*GHcoll[M022]);

    cell[FP00] = (rho * D::t[FP00]) * (1. + 3.*u[0] + 1.5* (2.*GHcoll[M200]-GHcoll[M020]-GHcoll[M002]) - 9.*GHcoll[M120] - (45./7.)*GHcoll[M220] - 9.*GHcoll[M202] );
    cell[FM00] = (rho * D::t[FM00]) * (1. - 3.*u[0] + 1.5* (2.*GHcoll[M200]-GHcoll[M020]-GHcoll[M002]) + 9.*GHcoll[M120] - (45./7.)*GHcoll[M220] - 9.*GHcoll[M202] );

    cell[F0P0] = (rho * D::t[F0P0]) * (1. + 3.*u[1] + 1.5* (2.*GHcoll[M020]-GHcoll[M200]-GHcoll[M002]) - 9.*GHcoll[M210] - (45./7.)*GHcoll[M220] + (18./5.)*GHcoll[M202] - 9.*GHcoll[M022] );
    cell[F0M0] = (rho * D::t[F0M0]) * (1. - 3.*u[1] + 1.5* (2.*GHcoll[M020]-GHcoll[M200]-GHcoll[M002]) + 9.*GHcoll[M210] - (45./7.)*GHcoll[M220] + (18./5.)*GHcoll[M202] - 9.*GHcoll[M022] );

    cell[F00P] = (rho * D::t[F00P]) * (1. + 3.*u[2] + 1.5* (2.*GHcoll[M002]-GHcoll[M200]-GHcoll[M020]) - 9.*GHcoll[M201] + (36./7.)*GHcoll[M220] - (27./5.)*GHcoll[M202] - 9.*GHcoll[M022] );
    cell[F00M] = (rho * D::t[F00M]) * (1. - 3.*u[2] + 1.5* (2.*GHcoll[M002]-GHcoll[M200]-GHcoll[M020]) + 9.*GHcoll[M201] + (36./7.)*GHcoll[M220] - (27./5.)*GHcoll[M202] - 9.*GHcoll[M022] );

    cell[FPP0] = (rho * D::t[FPP0]) * (1. + 3.* (+ u[0] + u[1]) +1.5*(2.*GHcoll[M200] + 2.*GHcoll[M020] - GHcoll[M002]) +9.*GHcoll[M110] + 4.5*( GHcoll[M210] + GHcoll[M120] - GHcoll[M102] - GHcoll[M012]) + 9.*GHcoll[M220] );
    cell[FMP0] = (rho * D::t[FMP0]) * (1. + 3.* (- u[0] + u[1]) +1.5*(2.*GHcoll[M200] + 2.*GHcoll[M020] - GHcoll[M002]) -9.*GHcoll[M110] + 4.5*( GHcoll[M210] - GHcoll[M120] + GHcoll[M102] - GHcoll[M012]) + 9.*GHcoll[M220] );
    cell[FPM0] = (rho * D::t[FPM0]) * (1. + 3.* (+ u[0] - u[1]) +1.5*(2.*GHcoll[M200] + 2.*GHcoll[M020] - GHcoll[M002]) -9.*GHcoll[M110] + 4.5*(-GHcoll[M210] + GHcoll[M120] - GHcoll[M102] + GHcoll[M012]) + 9.*GHcoll[M220] );
    cell[FMM0] = (rho * D::t[FMM0]) * (1. + 3.* (- u[0] - u[1]) +1.5*(2.*GHcoll[M200] + 2.*GHcoll[M020] - GHcoll[M002]) +9.*GHcoll[M110] + 4.5*(-GHcoll[M210] - GHcoll[M120] + GHcoll[M102] + GHcoll[M012]) + 9.*GHcoll[M220] );

    cell[FP0P] = (rho * D::t[FP0P]) * (1. + 3.* (+ u[0] + u[2]) +1.5*(2.*GHcoll[M200] + 2.*GHcoll[M002] - GHcoll[M020]) +9.*GHcoll[M101] + 4.5*( GHcoll[M201] + GHcoll[M102] + GHcoll[M120] - GHcoll[M021]) - (18./7.)*GHcoll[M220] + 9.*GHcoll[M202] );
    cell[FM0P] = (rho * D::t[FM0P]) * (1. + 3.* (- u[0] + u[2]) +1.5*(2.*GHcoll[M200] + 2.*GHcoll[M002] - GHcoll[M020]) -9.*GHcoll[M101] + 4.5*( GHcoll[M201] - GHcoll[M102] - GHcoll[M120] - GHcoll[M021]) - (18./7.)*GHcoll[M220] + 9.*GHcoll[M202] );
    cell[FP0M] = (rho * D::t[FP0M]) * (1. + 3.* (+ u[0] - u[2]) +1.5*(2.*GHcoll[M200] + 2.*GHcoll[M002] - GHcoll[M020]) -9.*GHcoll[M101] + 4.5*(-GHcoll[M201] + GHcoll[M102] + GHcoll[M120] + GHcoll[M021]) - (18./7.)*GHcoll[M220] + 9.*GHcoll[M202] );
    cell[FM0M] = (rho * D::t[FM0M]) * (1. + 3.* (- u[0] - u[2]) +1.5*(2.*GHcoll[M200] + 2.*GHcoll[M002] - GHcoll[M020]) +9.*GHcoll[M101] + 4.5*(-GHcoll[M201] - GHcoll[M102] - GHcoll[M120] + GHcoll[M021]) - (18./7.)*GHcoll[M220] + 9.*GHcoll[M202] );

    cell[F0PP] = (rho * D::t[F0PP]) * (1. + 3.* (+ u[1] + u[2]) +1.5*(2.*GHcoll[M020] + 2.*GHcoll[M002] - GHcoll[M200]) +9.*GHcoll[M011] + 4.5*( GHcoll[M021] + GHcoll[M012] + GHcoll[M210] + GHcoll[M201]) - (18./7.)*GHcoll[M220] - (18./5.)*GHcoll[M202] + 9.*GHcoll[M022] );
    cell[F0MP] = (rho * D::t[F0MP]) * (1. + 3.* (- u[1] + u[2]) +1.5*(2.*GHcoll[M020] + 2.*GHcoll[M002] - GHcoll[M200]) -9.*GHcoll[M011] + 4.5*( GHcoll[M021] - GHcoll[M012] - GHcoll[M210] + GHcoll[M201]) - (18./7.)*GHcoll[M220] - (18./5.)*GHcoll[M202] + 9.*GHcoll[M022] );
    cell[F0PM] = (rho * D::t[F0PM]) * (1. + 3.* (+ u[1] - u[2]) +1.5*(2.*GHcoll[M020] + 2.*GHcoll[M002] - GHcoll[M200]) -9.*GHcoll[M011] + 4.5*(-GHcoll[M021] + GHcoll[M012] + GHcoll[M210] - GHcoll[M201]) - (18./7.)*GHcoll[M220] - (18./5.)*GHcoll[M202] + 9.*GHcoll[M022] );
...
// Optimized way to compute RRs (general ordering of discrete velocities)
// (we only need 2nd-order RRs)
static void RRcomputeMoments(Array<T,D::q> const& cell, Array<T, D::q>& RR, T& rho) {
    Array<T, D::q> f;
    for (int i = 0; i<19; ++i) {
...
static void RRcomputeEquilibrium(T rho, Array<T, D::q> const& RReq, Array<T, D::q>& eq) {
    ...
    eq[FP00] = 0.5*rho * ( u[0] + RMeq[M200] - RMeq[M120] - RMeq[M102] - RMeq[M220] - RMeq[M202]);
    eq[FM00] = 0.5*rho * (-u[0] + RMeq[M200] + RMeq[M120] + RMeq[M102] - RMeq[M220] - RMeq[M202]);

    eq[F0P0] = 0.5*rho * ( u[1] + RMeq[M020] - RMeq[M210] - RMeq[M012] - RMeq[M220] - RMeq[M022]);
    eq[F0M0] = 0.5*rho * (-u[1] + RMeq[M020] + RMeq[M210] + RMeq[M012] - RMeq[M220] - RMeq[M022]);

    eq[F00P] = 0.5*rho * ( u[2] + RMeq[M002] - RMeq[M201] - RMeq[M021] - RMeq[M202] - RMeq[M022]);
    eq[F00M] = 0.5*rho * (-u[2] + RMeq[M002] + RMeq[M201] + RMeq[M021] - RMeq[M202] - RMeq[M022]);
