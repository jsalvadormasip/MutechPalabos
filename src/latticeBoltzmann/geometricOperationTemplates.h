...
template<typename T> struct SymmetricTensorImpl<T,0> {
    ...
    static void matVectMult([[maybe_unused]] Array<T,n> const& mat, [[maybe_unused]] Array<T,0> const& vect, [[maybe_unused]] Array<T,0>& result) {
        result.resetToZero();
    }
    static T tensorNormSqr([[maybe_unused]] Array<T,n> const& mat) {
        return T();
    }
    static T contractIndexes([[maybe_unused]] Array<T,n> const& A, [[maybe_unused]] Array<T,n> const& B) {
        return T();
    }
...
template<typename T> struct SymmetricRankThreeTensorImpl<T,0> {
    ...
    static void multWithRankTwoSymTensor([[maybe_unused]] Array<T,n> const&A, [[maybe_unused]] Array<T,SymmetricTensorImpl<T,0>::n> const &B,
                                         Array<T,0> &x) {
        x.resetToZero();
    }
};
