...
struct ExternalForceAccess<T,Descriptor,0> {
    static T getComponent([[maybe_unused]] Cell<T,Descriptor> const& cell, [[maybe_unused]] plint iD) {
        return T();
    }

    static void setComponent([[maybe_unused]] Cell<T,Descriptor> const& cell, [[maybe_unused]] plint iD, [[maybe_unused]] T component) { }
    static Array<T,0> get([[maybe_unused]] Cell<T,Descriptor> const& cell) {
        return Array<T,0>();
    }
    static void set( [[maybe_unused]] Cell<T,Descriptor>& cell,
                     [[maybe_unused]] Array<T,0> const& force ) {}
};
