...
namespace npfem {
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void SimplicialLDLTSolver::initialize(const SparseMatrix &A, [[maybe_unused]] unsigned int iteration)
{
    solver_.compute(A);
}
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE VectorX SimplicialLDLTSolver::solve(const VectorX &b, [[maybe_unused]] const VectorX &x0) const
{
