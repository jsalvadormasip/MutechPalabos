...
if not DragCalculation:
    iterations = [50]
    file_path_template_input = 'C:/Users/jordi/Documents/GitHub/MutechPalabos/UnderstandingGridRefinement/tmp jordiPowerFlowCopy 30-07-2024 16-56/slice_y_00_{:08d}.vtm'
